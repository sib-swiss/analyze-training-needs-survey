...
cat(likert_toggle("topics-swiss",
  all_expr = \(counts) plot_likert(
    survey_long, all_topic_questions,
    split_by = "region", split_values = c("Switzerland", "Other"),
    counts = counts, labels = TRUE
  ),
  width = 16, height = 13
))
```
...
cat(likert_toggle("topics-career",
  all_expr = \(counts) plot_likert(
    survey_long, all_topic_questions,
...
cat(likert_toggle("barriers-swiss",
  all_expr = \(counts) plot_likert(
    survey_long,
...
cat(likert_toggle("barriers-career",
  all_expr = \(counts) plot_likert(
    survey_long,
    "Please indicate how much each of the following factors would be a barrier for your participation in a SIB training course.",
    split_by = "Which career stage are you currently in?",
...
cat(likert_toggle("barriers-sib",
  all_expr = \(counts) plot_likert(
    survey_long,
    "Please indicate how much each of the following factors would be a barrier for your participation in a SIB training course.",
    split_by = "When did you last attend a SIB course? ",
...
cat(likert_toggle("formats-swiss",
  all_expr = \(counts) plot_likert(
    survey_long,
...
cat(likert_toggle("formats-career",
  all_expr = \(counts) plot_likert(
    survey_long,
    "Specify which learning formats you prefer Note: these are not mutually exclusive, i.e. some can be used in combination",
    split_by = "Which career stage are you currently in?",
